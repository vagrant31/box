...
<body>
	...
	<form:form id="inputForm" modelAttribute="tasksDetail" action="${ctx}/task/tasksDetail/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="receiveUserIdRecent" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">专业人员姓名：</label>
			<div class="controls">
				<form:input path="receiveUserNameRecent" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">退回任务标记（0接受，1退回）：</label>
			<div class="controls">
				<form:input path="giveUpFlag" htmlEscape="false" maxlength="1" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
